...
export default function PostCard({ post, userId, setPosts }: PostCardProps) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition p-3 sm:p-4 w-full min-w-0">
      {/* Header */}
      <div className="flex items-center mb-3 justify-between gap-2 min-w-0">
        ...
        {isOwner && (
          <button
            ...
            className="w-8 h-8 flex items-center justify-center rounded-full bg-red-50 hover:bg-red-100 text-red-500 transition-all duration-200 shrink-0 ml-2"
          >
            🗑️
          </button>
        )}
      ...
      <div className="flex items-center gap-1 mt-3 text-lg sm:text-xl">
        ...
        <span className="text-sm text-gray-600 ml-0.5">{likes.length}</span>
          ...
          >
            ...
            >
              ...
              <div className="p-4 border-t border-gray-200/50 bg-white/60 backdrop-blur-xl">
                <div className="flex items-center gap-2 sm:gap-3 bg-white rounded-2xl px-3 py-2 shadow-sm border">
                  <input
                    type="text"
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-xl bg-gradient-to-r from-pink-500 to-rose-500 text-white text-sm font-medium hover:scale-105 transition shrink-0"
                  >
                    Send
                  </button>
                </div>
